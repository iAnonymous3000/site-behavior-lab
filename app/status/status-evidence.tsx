        ...
        <div className="status-card-grid">
          <article className="status-card">
            ...
            <p>
              ...
              cohort; {snapshot.coverageSiteCount.toLocaleString()} sites have at least one
              successful load.
            </p>
