...
// zero-coercing malformed metrics) in build-time JS. Compiles with the same
// tsconfig the unit tests use, then runs the compiled CLI.
...
execFileSync(process.execPath, [path.join(rootDir, ".unit-test-dist", "lib", "static-report-manifest-cli.js")], {
  cwd: rootDir,
  stdio: "inherit"
});
