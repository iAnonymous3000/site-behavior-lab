...
| `SITE_BEHAVIOR_LAB_REPORT_MIN_SURVIVAL_MS` | `60000` | Minimum time (capped at five minutes) a newly committed share survives count pruning, preventing a successful concurrent save from returning an already-dead link. Age expiry still wins. |
