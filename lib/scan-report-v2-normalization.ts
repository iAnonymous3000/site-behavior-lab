...
> = Object.freeze({
  "node-playwright": Object.freeze([
    // Retired by the node-detectors-v10 measurement epoch, which admits the v1
    // listener-withheld disclosure (LISTENER_DETECTION_WITHHELD_WARNING) as one
    // exact fixed scanner warning. Nothing an older pass admitted was removed
  ...
  "pagegraph-import": Object.freeze([
    // Retired by the node-detectors-v10 listener-withheld disclosure; see the
