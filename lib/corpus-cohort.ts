...
export const REVIEWED_MEASUREMENT_LINES: readonly string[] = Object.freeze([
  ...
  // OffscreenCanvas 2D work the fingerprint observer now reads in the page and
...
// Lives in its own module so the homepage can import it without this module's
// report-view graph; re-exported so every existing consumer is unchanged.
export { corpusCohortDifferences } from "./corpus-cohort-differences";
