...
export type CorpusExportPayload = {
  ...
  siteCount: number;
  /** Distinct sites whose lead runs are neither failed nor capped: the statistics basis. */
